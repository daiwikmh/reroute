...
import { domainSlug, buildTxtRecord } from "./dns/record.js";
...
app.get("/debug-txt", (c) =>
  c.json({
    publicBaseUrlDirect: PUBLIC_BASE_URL,
    sampleRecord: buildTxtRecord({
      domain: Buffer.from("debug-check.example.com"),
      owner: "GDEBUG",
      pay_to: "GDEBUG",
      reference_asset: "CDEBUG",
      reference_price: 1n,
      accepted_assets: [],
      facilitator_url: "https://debug",
      active: true,
      registered_at: 0n,
      updated_at: 0n,
    }),
